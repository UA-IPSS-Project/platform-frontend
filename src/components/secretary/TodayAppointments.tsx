...
export function TodayAppointments({ appointments, onViewAppointment, onShowHistory, onShowDocumentSearch, isDarkMode, showFilter = false }: TodayAppointmentsProps) {
