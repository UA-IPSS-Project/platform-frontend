      ...
      <div className="overflow-y-auto max-h-80">
        {notifications.length === 0 ? (
          ...
          notifications.map((notification) => (
            <div
              key={notification.id}
              className={`p-4 border-b border-pink-50 dark:border-gray-700/50 hover:bg-pink-50/50 dark:hover:bg-gray-800 transition-colors cursor-pointer ${
                !notification.isRead ? 'bg-purple-50/30 dark:bg-gray-800/50' : ''
              }`}
