...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-2xl bg-muted/40 p-1.5 text-muted-foreground backdrop-blur-md border border-border/40",
      className
    )}
    {...props}
  />
